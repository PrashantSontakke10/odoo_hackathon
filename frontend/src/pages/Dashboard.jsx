             ...
             <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
                 ...
                 <div className="glass-panel" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                     ...
                     <div style={{ display: 'flex', gap: '1rem', marginTop: 'auto' }}>
                         ...
                         <Link to="/expenses" className="btn-primary" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', textDecoration: 'none', background: 'rgba(255,255,255,0.1)', color: 'white', flex: 1 }}>View Vault</Link>
                     </div>
                 </div>
                 ...
                 {user?.role === 'Manager' && (
                      <div className="glass-panel" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1rem', background: 'linear-gradient(rgba(30, 41, 59, 0.7), rgba(16, 185, 129, 0.1))' }}>
                          ...
                          <Link to="/expenses" className="btn-primary" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', textDecoration: 'none', background: 'var(--success)', color: '#0f172a' }}>Review Requests</Link>
                      </div>
                 )}
             </div>
         </div>
